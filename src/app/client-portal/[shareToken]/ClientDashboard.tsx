        ...
        item.value ? (
          <div key={i} className="flex items-start gap-3 bg-white/[0.03] border border-white/[0.06] rounded-xl p-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm text-zinc-200 mt-0.5 font-medium break-words">{item.value}</p>
            </div>
          </div>
        ) : null
      )}
            ...
            <div key={msg.id} className={cn("flex", isMe ? "justify-end" : "justify-start")}>
              ...
              <div className={cn(
                ...
                isMe
                  ...
                  : "bg-white/[0.07] border border-white/[0.08] text-zinc-200 rounded-bl-sm"
              )}>
            ...
            {response.agent_note && (
              <div className="bg-[#FF5C33]/5 border border-[#FF5C33]/15 rounded-2xl p-4 flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-200 leading-relaxed">{response.agent_note}</p>
