        ...
        <div className="mt-4 space-y-6">
            ...
            {bookingsLoading ? (
                ...
                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-16 text-center text-slate-600 dark:text-zinc-400 flex flex-col items-center justify-center shadow-xl">
                    ...
                    <Button onClick={() => setIsBookingDialogOpen(true)} className="px-6 py-2.5 aurora-gradient text-slate-900 dark:text-white border-none rounded-xl text-sm font-bold transition-all hover:brightness-110 active:scale-98 flex items-center gap-2 h-11 cursor-pointer">
                        ...
                        >
                            <div className="flex items-center justify-between mb-3 relative">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 dark:text-white text-base leading-tight group-hover:text-primary transition-colors">{booking.title}</h4>
                                        <p className="text-[10px] text-slate-600 dark:text-zinc-400 uppercase tracking-wider font-bold mt-0.5">{booking.service_type}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
