    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#0c0c0e]/95 backdrop-blur-2xl border border-white/[0.08] rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/5">
          <div>
            <h2 className="text-base font-bold text-slate-900 dark:text-white">Create Enquiry Form</h2>
            <p className="text-xs text-slate-600 dark:text-zinc-400 mt-0.5">Generate a shareable link for your client</p>
          </div>
          <button onClick={onClose} className="text-slate-600 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-white transition-colors p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
          {!createdForm ? (
            <>
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-3.5 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm resize-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-3.5 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm [color-scheme:dark] transition-all"
                />
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full h-11 rounded-xl aurora-gradient text-slate-900 dark:text-white font-bold text-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2 mt-2 cursor-pointer hover:brightness-110 active:scale-98"
              >
                {loading ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-center text-slate-900 dark:text-white font-bold text-base">Form created!</p>
              <p className="text-center text-slate-600 dark:text-zinc-400 text-xs">Share this link with your client:</p>

              <div className="bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/10 rounded-xl p-3 flex items-center gap-2">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    copied
                      ...
                      : "bg-primary/20 text-slate-900 dark:text-white border border-primary/30 hover:bg-primary/30"
                  )}
                >
                  {copied ? "Copied!" : "Copy"}
                </button>
