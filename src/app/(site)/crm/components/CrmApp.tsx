...
export function CrmApp() {
    ...
    return (
        <div className="crm-page bg-[#EFECE5] dark:bg-black transition-colors duration-300">
            <div className="crm-container">
                <div className="crm-layout">
                    ...
                    <div className={cn(
                        ...
                        <div className={cn(
                            "flex flex-col w-full bg-white/40 dark:bg-white/[0.03] backdrop-blur-xl border border-slate-300/60 dark:border-white/[0.08] rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all duration-300",
                            ...
                            <nav className="flex-1 py-4 space-y-1.5 overflow-y-auto crm-nav-scroll px-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                                {[
                                    ...
                                    <Button key={tab.id} onClick={() => setActiveTab(tab.id)} variant="ghost" className={cn("w-full justify-start h-10 px-3 transition-all group cursor-pointer", activeTab === tab.id ? "bg-primary/10 dark:bg-primary/20 text-slate-900 dark:text-white border border-primary/20 dark:border-primary/40 font-bold hover:bg-primary/20 hover:border-primary/30 dark:hover:bg-primary/30 dark:hover:border-primary/60" : "text-slate-600 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200/50 dark:hover:bg-white/5", isSidebarExpanded ? "" : "w-10 px-0 justify-center")}>
                                        <tab.icon className={cn("w-4 h-4 shrink-0", activeTab === tab.id ? "text-primary" : "text-slate-600 dark:text-zinc-400 group-hover:text-slate-900 dark:group-hover:text-slate-900 dark:hover:text-white")} />
                                        <span className={cn(
                            ...
                            <div className="pt-4 border-t border-white/[0.08] px-1 space-y-1.5 mt-auto">
                                <Button onClick={() => setIsSidebarExpanded(!isSidebarExpanded)} variant="ghost" className={cn("w-full justify-start h-10 px-3 hover:bg-slate-200/50 dark:hover:bg-white/10 transition-all group text-slate-600 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-white cursor-pointer", isSidebarExpanded ? "" : "w-10 px-0 justify-center")}>
                    ...
                    {/* Mobile Navigation */}
                    <div className="lg:hidden block sticky top-14 z-30 mb-2 -mx-2 bg-[#EFECE5]/90 dark:bg-black/90 backdrop-blur-md">
                                ...
                                {[
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            activeTab === tab.id
                                                ? "bg-primary/10 dark:bg-primary/20 text-slate-900 dark:text-white border-primary/20 dark:border-primary/40 font-bold hover:bg-primary/20 hover:border-primary/30 dark:hover:bg-primary/30 dark:hover:border-primary/60"
                                                : "bg-white/80 dark:bg-white/5 text-slate-600 dark:text-zinc-400 border-slate-200 dark:border-white/10 hover:bg-slate-200/50 dark:hover:bg-white/10 hover:text-slate-900 dark:hover:text-white"
                                        )}
                                    >
                                        <tab.icon className={cn("w-3.5 h-3.5", activeTab === tab.id ? "text-primary" : "text-slate-600 dark:text-zinc-400")} />
                                        {tab.label}
                                    </button>
                                ))}
                            </div>
                    ...
                    <div className="crm-main-content px-4 pt-0 pb-8 sm:px-6 lg:px-8">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                            <div>
                                ...
                                <p className="text-slate-600 dark:text-zinc-400 text-sm mt-1 font-medium">
                            ...
                            <div className="flex items-center gap-3">
                                <Button 
                                    ...
                                    className="px-6 py-2.5 aurora-gradient text-slate-900 dark:text-white border-none rounded-xl text-sm font-bold transition-all hover:brightness-110 active:scale-98 flex items-center gap-2 h-11 cursor-pointer"
                                >
                        ...
                        <div className="min-h-[60vh]">
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white/40 dark:bg-white/[0.03] backdrop-blur-xl border border-slate-300/60 dark:border-white/[0.08] rounded-2xl p-4 lg:p-5 shadow-sm dark:shadow-xl relative overflow-hidden">
                                        <div className="flex flex-col lg:flex-row gap-4 relative z-10 w-full mb-4">
                                            <div className="relative flex-1 w-full min-w-0">
                                                <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-slate-600 dark:text-zinc-400" />
                                                <Input
                                                    placeholder={activeTab === 'clients' ? "Search clients by name, email, phone, tags..." : "Search trips, destinations, notes..."}
                                                    className="w-full pl-11 h-12 bg-white/60 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-900 dark:text-white placeholder:text-slate-600 dark:text-slate-400 dark:placeholder:text-zinc-500 focus-visible:ring-primary/50 rounded-xl shadow-inner text-sm transition-all hover:bg-slate-100 dark:hover:bg-white/10"
                                            ...
                                            <div className="flex flex-wrap items-center gap-3 shrink-0">
                                                {activeTab === 'clients' && (
                                                    <Select value={filters.clientsActivityFilter} onValueChange={filters.setClientsActivityFilter}>
                                                        <SelectTrigger className="w-[150px] lg:w-[160px] bg-white/60 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-900 dark:text-white h-12 rounded-xl">
                                                            <Filter className="w-4 h-4 mr-2 text-primary" />
                                                            <SelectValue placeholder="All Activity" />
                                                        </SelectTrigger>
                                                        <SelectContent className="bg-white/95 dark:bg-[#0c0c0e]/95 backdrop-blur-2xl border-slate-200 dark:border-white/10 text-slate-900 dark:text-white">
                                                ...
                                                {activeTab === 'trips' && (
                                                    <>
                                                        <Select value={filters.tripsPipelineFilter} onValueChange={filters.setTripsPipelineFilter}>
                                                            <SelectTrigger className="w-[150px] lg:w-[170px] bg-white/60 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-900 dark:text-white h-12 rounded-xl">
                                                        ...
                                                        <div className="flex border border-slate-200 dark:border-white/10 rounded-xl overflow-hidden h-12 bg-white/60 dark:bg-white/5">
                                                            <button
                                                                onClick={() => filters.setTripsViewMode('table')}
                                                                className={cn("px-4 transition-colors flex items-center justify-center cursor-pointer", filters.tripsViewMode === 'table' ? "bg-primary/10 dark:bg-primary/20 text-primary dark:text-white border-r border-slate-200 dark:border-primary/40 font-bold" : "text-slate-600 dark:text-slate-400 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200/50 dark:hover:bg-white/5")}
                                                                title="List View"
                                                            >
                                                            ...
                                                            <button
                                                                ...
                                                                className={cn("px-4 transition-colors flex items-center justify-center cursor-pointer", filters.tripsViewMode === 'kanban' ? "bg-primary/10 dark:bg-primary/20 text-primary dark:text-white border-l border-slate-200 dark:border-primary/40 font-bold" : "text-slate-600 dark:text-slate-400 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200/50 dark:hover:bg-white/5")}
                                                                title="Kanban Board"
                                                            >
                                                ...
                                                <Button
                                                    ...
                                                    className="border-slate-200 dark:border-white/10 bg-white/60 dark:bg-white/5 text-slate-600 dark:text-zinc-300 hover:bg-slate-200/50 dark:hover:bg-white/10 hover:text-slate-900 dark:hover:text-white h-12 px-4 rounded-xl shrink-0 cursor-pointer"
                                                >
