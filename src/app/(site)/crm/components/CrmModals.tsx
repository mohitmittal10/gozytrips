                ...
                <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto bg-[#EFECE5]/95 dark:bg-[#0c0c0e]/95 backdrop-blur-2xl border-slate-300 dark:border-white/10 text-slate-900 dark:text-white shadow-2xl">
                    <DialogHeader>
                        ...
                        <div className="flex items-center gap-4 mt-4">
                            ...
                            <Button onClick={handleDownloadPdf} disabled={!selectedTripForModal} className="w-fit aurora-gradient text-slate-900 dark:text-white border-none rounded-xl font-bold hover:brightness-110">
