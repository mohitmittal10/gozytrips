...
export const CRM_COLORS = {
  bg: "#EFECE5", // Light mode default
  cardBg: "#ffffff", // Light mode default
  cardBorder: "border-zinc-200 dark:border-zinc-800",
  mutedText: "#71717a", // zinc-500
  headingText: "#18181b", // zinc-900
  primaryButton: "bg-zinc-900 hover:bg-zinc-800 text-white border-zinc-800 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:text-zinc-100 dark:border-zinc-700/80 font-medium shadow-sm transition-all",
  secondaryButton: "bg-white hover:bg-zinc-50 text-zinc-900 border border-zinc-200 dark:bg-zinc-900/80 dark:hover:bg-zinc-800 dark:text-zinc-300 dark:border-zinc-800 font-medium transition-all",
} as const;
...
const statusMap: Record<string, StatusStyle> = {
  draft: {
    label: "Draft",
    badgeClass: "bg-zinc-500/10 text-zinc-700 dark:text-zinc-300 border-zinc-500/20 font-medium",
    dotClass: "bg-zinc-500 dark:bg-zinc-400",
    hex: "#71717a",
    borderColor: "border-zinc-300 dark:border-zinc-700/50",
    bgColor: "bg-zinc-100 dark:bg-zinc-800/40",
  },
  proposed: {
    label: "Proposed",
    badgeClass: "bg-amber-500/10 text-amber-700 dark:text-amber-400 border-amber-500/20 font-medium",
  ...
  sent: {
    label: "Sent",
    badgeClass: "bg-blue-500/10 text-blue-700 dark:text-blue-400 border-blue-500/20 font-medium",
  ...
  booked: {
    ...
    dotClass: "bg-emerald-600 dark:bg-emerald-500 dark:bg-emerald-400",
    hex: "#10b981",
  ...
  completed: {
    label: "Completed",
    badgeClass: "bg-teal-500/10 text-teal-700 dark:text-teal-400 border-teal-500/20 font-medium",
  ...
  rejected: {
    label: "Rejected",
    badgeClass: "bg-rose-500/10 text-rose-700 dark:text-rose-400 border-rose-500/20 font-medium",
...
export const CRM_AVATAR_CLASS = "bg-zinc-100 text-zinc-600 border border-zinc-200 dark:bg-zinc-900 dark:text-zinc-200 dark:border-zinc-800 font-medium";
