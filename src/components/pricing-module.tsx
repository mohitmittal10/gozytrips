    ...
    >
      ...
      <CardHeader className="bg-white/5 pb-4">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-xl">Trip Costing Builder</CardTitle>
        </div>
        <CardDescription>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center justify-between">
               ...
               <Button variant="outline" size="sm" onClick={addManualOption} className="gap-2 h-8 border-emerald-500/20 bg-emerald-500/5 hover:bg-emerald-500/10 text-emerald-400">
          ...
          <div className="space-y-6">
             ...
             {/* Live Costing Summary — Emerald Theme */}
             <div className="space-y-2 bg-emerald-500/10 p-4 rounded-xl border border-emerald-500/20 text-sm">
                ...
                <div className="pt-2 mt-2 border-t border-emerald-500/20 flex justify-between font-bold text-white text-lg mb-4">
