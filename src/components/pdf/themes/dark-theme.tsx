            ...
            <div data-pdf-section="cover" style={{ paddingBottom: "10px" }}>
                <div style={{ position: "relative", height: "300px", overflow: "hidden", background: "#0f172a" }}>
                    ...
                    <div style={{ position: "absolute", bottom: "40px", left: "45px", right: "45px", zIndex: 1 }}>
                        <h1 data-field="itinerary.title" style={{ fontSize: "40px", fontWeight: 900, margin: "0 0 8px 0", color: "#ffffff", lineHeight: "1.1", letterSpacing: "-1px", fontFamily: "'Outfit', sans-serif", textShadow: `0 0 20px rgba(${rgbAccent}, 0.3)` }}>{title}</h1>
                        {agent.agentName && <p style={{ fontSize: "13px", color: "#94a3b8", margin: 0, fontWeight: 500 }}>Prepared By: {agent.agentName}</p>}
                    </div>
                </div>
                ...
                <div style={{ padding: "45px" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: clientName && (agent.agentName || agent.companyName) ? "1fr 1fr" : "1fr", gap: "20px", marginTop: "30px", paddingTop: "25px", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
                        {/* Client Info Card */}
                        {clientName ? (
                        ...
                        {(agent.agentName || agent.companyName || agent.agentPhone || agent.agentEmail || agent.agentWebsite) ? (
                            <div style={{ padding: "20px 24px", background: "rgba(255,255,255,0.025)", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.08)", borderLeft: "3px solid #ec4899" }}>
                                ...
                                {agent.companyName && <p style={{ fontWeight: 800, color: "#ffffff", fontSize: "16px", margin: "0 0 4px 0", fontFamily: "'Outfit', sans-serif" }}>{agent.companyName}</p>}
                                {agent.agentName && <p style={{ fontWeight: 700, color: "#cbd5e1", fontSize: "14px", margin: "0 0 6px 0", fontFamily: "'Outfit', sans-serif" }}>{agent.agentName}</p>}
                ...
                <div data-pdf-section="about" style={{ padding: "10px 45px 45px 45px" }}>
                    <div style={{ display: "flex", gap: "40px", alignItems: "flex-start", background: "rgba(255,255,255,0.02)", padding: "30px", borderRadius: "10px", border: "1px solid rgba(255,255,255,0.06)", boxShadow: `0 4px 20px rgba(0,0,0,0.15)` }}>
                        ...
                        <div style={{ flex: 1 }}>
                            ...
                            <h2 data-field="aboutPlace.title" style={{ margin: "0 0 20px 0", fontSize: "28px", color: "#ffffff", fontFamily: "'Outfit', sans-serif", fontWeight: 800, letterSpacing: "-0.5px" }}>{aboutPlace.title}</h2>
                            <p data-field="aboutPlace.description" style={{ margin: "0 0 24px 0", color: "#94a3b8", fontSize: "14px", lineHeight: "1.8", fontWeight: 500 }}>{renderFormattedText(aboutPlace.description)}</p>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                                {(aboutPlace.highlights || []).map((hl: string, i: number) => (
                                    <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "12px", background: "rgba(255,255,255,0.03)", padding: "12px", borderRadius: "6px", border: "1px solid rgba(255,255,255,0.04)" }}>
                                        ...
                                        <span data-field={`aboutPlace.highlights[${i}]`} style={{ fontSize: "13px", color: "#cbd5e1", fontWeight: 600 }}>{renderFormattedText(hl)}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div style={{ display: "flex", alignItems: "stretch", marginBottom: "14px", borderRadius: "10px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.06)", boxShadow: `0 4px 15px rgba(0,0,0,0.1)` }}>
                            ...
                            <div style={{ flex: 1, padding: "12px 20px", borderLeft: `3px solid ${accent}`, background: "rgba(255,255,255,0.03)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                                <div style={{ display: "flex", alignItems: "baseline", gap: "12px" }}>
                                    ...
                                    <h3 data-field={`days[${index}].location`} style={{ fontSize: "16px", fontWeight: 800, margin: 0, textTransform: "uppercase", letterSpacing: "1px", color: "#ffffff" }}>{formatTitleCase(day.areaFocus)}</h3>
                                </div>
                        ...
                        <div style={{ padding: "20px 24px", borderRadius: "10px", border: "1px solid rgba(255,255,255,0.04)", background: "rgba(255,255,255,0.015)", display: "flex", flexDirection: "column", gap: "12px" }}>
                            {Array.isArray(day.timeline) && day.timeline.map((step, si) => (
                                <div key={si} style={{ display: "flex", alignItems: "flex-start", gap: "20px", padding: "12px 16px", borderLeft: `2.5px solid rgba(${rgbAccent}, 0.35)`, borderRadius: "0 8px 8px 0", background: "rgba(255,255,255,0.025)" }}>
                                    ...
                                    <p data-field={`days[${index}].activities[${si}]`} style={{ margin: 0, fontSize: "13.5px", lineHeight: "1.75", color: "#cbd5e1", flex: 1, fontWeight: 500 }}>{renderFormattedText(step.details)}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                        ...
                        {cabs.map((c, i) => (
                            <div key={`cab-${i}`} style={{ display: "flex", gap: "20px", border: "1px solid rgba(255,255,255,0.06)", padding: "16px", background: "rgba(255,255,255,0.02)", borderRadius: "8px" }}>
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    {c.vehicleType && <h4 style={{ margin: "0 0 12px 0", fontSize: "15px", color: "#ffffff", fontWeight: 700 }}>{c.vehicleType}</h4>}
                                    <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "6px", fontSize: "11px", color: "#94a3b8" }}>
                                        {c.route && <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid rgba(255,255,255,0.05)", paddingBottom: "4px" }}><span>RTE</span><span style={{ fontWeight: 600, color: "#cbd5e1" }}>{c.route}</span></div>}
                                        {c.pickupTime && <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid rgba(255,255,255,0.05)", paddingBottom: "4px" }}><span>PICK</span><span style={{ fontWeight: 600, color: "#cbd5e1" }}>{c.pickupTime}</span></div>}
                        ...
                        {buses.map((b, i) => (
                            <div key={`bus-${i}`} style={{ display: "flex", gap: "20px", border: "1px solid rgba(255,255,255,0.06)", padding: "16px", background: "rgba(255,255,255,0.02)", borderRadius: "8px" }}>
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    {b.busType && <h4 style={{ margin: "0 0 12px 0", fontSize: "15px", color: "#ffffff", fontWeight: 700 }}>{b.busType}</h4>}
                                    <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "6px", fontSize: "11px", color: "#94a3b8" }}>
                                        {b.route && <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid rgba(255,255,255,0.05)", paddingBottom: "4px" }}><span>RTE</span><span style={{ fontWeight: 600, color: "#cbd5e1" }}>{b.route}</span></div>}
                                        {b.departureTime && <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid rgba(255,255,255,0.05)", paddingBottom: "4px" }}><span>DEP</span><span style={{ fontWeight: 600, color: "#cbd5e1" }}>{b.departureTime}</span></div>}
                            ...
                            <div style={{ flex: 1, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "10px", padding: "30px" }}>
                                ...
                                <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: "12px" }}>
                                    {inclusionsList.map((inc, i) => (
                                        <li key={i} style={{ display: "flex", gap: "12px", fontSize: "13px", color: "#cbd5e1", fontWeight: 500 }}><span style={{ color: accent }}>+</span> <span data-field={`inclusions[${i}]`}>{renderFormattedText(inc)}</span></li>
                                    ))}
                                </ul>
                            </div>
                        )}
                            ...
                            <div style={{ flex: 1, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "10px", padding: "30px" }}>
                                ...
                                <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: "12px" }}>
                                    {exclusionsList.map((exc, i) => (
                                        <li key={i} style={{ display: "flex", gap: "12px", fontSize: "13px", color: "#94a3b8", fontWeight: 500 }}><span style={{ color: "#64748b" }}>-</span> <span data-field={`exclusions[${i}]`}>{renderFormattedText(exc)}</span></li>
                                    ))}
                                </ul>
                            </div>
                        )}
