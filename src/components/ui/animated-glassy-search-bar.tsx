...
const AnimatedGlassySearchBar: React.FC<AnimatedGlassySearchBarProps> = ({
  ...
  return (
    <div className={cn("w-full max-w-2xl relative group", className)}>
      ...
      >
        <div className="relative flex flex-col sm:flex-row gap-2 p-2 rounded-[15px] bg-[#05050a]/90 backdrop-blur-3xl">
          <div className="flex-grow flex items-center px-4 gap-3">
            ...
            <input 
              ...
              className="bg-transparent border-none focus:ring-0 text-white placeholder-zinc-700 text-base w-full py-2.5 font-medium outline-none"
            />
          </div>
          ...
          <div className="flex items-center gap-2 p-1">
            <RippleButton 
              ...
              className="sm:w-auto w-full px-8 py-3 rounded-xl bg-indigo-600 text-white font-black text-sm tracking-tight shadow-xl shadow-indigo-500/20"
            >
              {buttonText}
            </RippleButton>
          </div>
