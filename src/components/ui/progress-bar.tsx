  ...
  return (
    <div className={`w-full ${className}`}>
      <div className="flex items-baseline justify-between gap-3">
        <span
          id={labelId}
          className="truncate text-[11px] font-normal text-stone-600 dark:text-stone-300"
        >
          {label}
        </span>
        ...
        >
          <motion.span
            className="col-start-1 row-start-1 whitespace-nowrap text-[11px] font-normal leading-5"
            initial={false}
          ...
          <motion.span
            className="col-start-1 row-start-1 whitespace-nowrap font-mono text-[11px] font-normal leading-5 tabular-nums"
            initial={false}
      ...
      <div
        ...
        aria-valuemax={max}
        {...measured}
        className="mt-1.5 rounded-[4px] bg-stone-200/60 p-[2px] shadow-[inset_0_1px_2px_rgba(28,25,23,0.1),inset_0_0_0_1px_rgba(28,25,23,0.06)] dark:bg-[#1D1D1A] dark:shadow-[inset_0_1px_2px_rgba(0,0,0,0.45)]"
      >
