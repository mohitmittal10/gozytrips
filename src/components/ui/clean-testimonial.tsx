...
const testimonials = [
    {
        quote: "The attention to detail in their itineraries is unmatched. Every destination feels intentionally chosen.",
        author: "Sarah Chen",
    ...
    {
        quote: "Finally, a platform that understands that simplicity is the ultimate sophistication in travel planning.",
        author: "Marcus Webb",
        role: "Digital Nomad",
        company: "Remote Life",
    ...
    {
        quote: "This service redefined our entire approach to exploring new cities.",
        author: "Elena Frost",
...
export function Testimonial() {
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="pointer-events-none absolute z-50 opacity-0 md:opacity-100"
                style={{
                    x: cursorX,
                    y: cursorY,
                    translateX: "-50%",
            ...
            <motion.div
                ...
                transition={{ duration: 0.3 }}
            >
                <span className="text-[10px] text-muted-foreground uppercase tracking-widest font-mono hidden md:inline-block">Click anywhere to next</span>
                <span className="text-[10px] text-muted-foreground uppercase tracking-widest font-mono md:hidden">Tap to next</span>
            </motion.div>
        </div>
    )
}
