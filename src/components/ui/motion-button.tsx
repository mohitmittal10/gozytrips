...
const MotionButton: FC<Props> = ({ label, classes }) => {
  return (
    ...
    >
      ...
      <span className='button-text text-foreground group-hover:text-background font-manrope absolute top-2/4 left-2/4 ml-6 -translate-x-2/4 -translate-y-2/4 text-center text-lg font-medium tracking-tight whitespace-nowrap duration-500'>
        {label}
      </span>
    </button>
  )
