...
export default function AnimatedTypography() {
    ...
    return (
        <div className="w-full h-[50vh] min-h-[400px] bg-neutral-950 dark:bg-black text-white flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <p className="text-zinc-400 text-sm md:text-base mb-4 tracking-[0.3em] uppercase z-10 font-light relative">
